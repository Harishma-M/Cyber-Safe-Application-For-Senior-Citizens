...
Cyber Safe Application for Senior Citizens is a mobile app designed to improve cybersecurity awareness among elderly users. It helps them recognize phishing attacks, scam calls, fake messages, malicious links, OTP fraud, and other common cyber threats through simple lessons, interactive quizzes, and an accessible user interface. The application promotes safe online habits with large fonts, voice-assisted guidance, and an intuitive design tailored for senior citizens.
